...
export type MnoTransaction = { id: number; walletId: number; mnoWalletName: string; agentNumber: string; transactionType: TransactionType; amount: number; previousBalance: number; balance: number; date: string; clientPhone: string; clientId?: string; clientName?: string; status: TransactionStatus };
